...
export class TLSSocketBuilder implements ISocketBuilder {
  ...
  public build(): Promise<tls.TLSSocket | net.Socket> {
    return SocketHelper.createTLSDestinationSocket(this.hostname, this.port, this.sourceSocket, () => this.closeFn());
  }
